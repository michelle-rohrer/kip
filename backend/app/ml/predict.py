...
def predict_current_risk(db: Session, *, player_id: int, player_position: str | None = None) -> PredictionResult:
    features_df = build_player_feature_frame(db, player_id=player_id, player_position=player_position)
